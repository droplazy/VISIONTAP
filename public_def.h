...
#define VERIFY_CODE "GXFC" //作为设备的固定较麻岩 用于请求qmtt 和htpp
//#define IP_HOST "42.192.211.207"
#define IP_HOST "192.168.10.103"
...
#define TIKTOK_SEND_MESSAGE_UI_2_CV    "/data/machine_vision/apppic/editsearch.png"   // 发私信
...
#define TIKTOK_LIVING_KEYBOARD_2_UI_CV    "/data/machine_vision/apppic/keyboard_2.png"   //
